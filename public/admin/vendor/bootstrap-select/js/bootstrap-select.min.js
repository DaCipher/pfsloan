...
!(function (e, t) {
    ...
    !(function (P) {
        ...
        var Y = function (e, t) {
            var i = this;
            p.useDefault ||
                ((P.valHooks.select.set = p._set), (p.useDefault = !0)),
                (this.$element = P(e)),
                ...
                setPlaceholder: function () {
                    ...
                    if (this.options.title && !this.multiple) {
                        ...
                        n &&
                            ...
                            (!n &&
                                0 ===
                                    this.selectpicker.view.titleOption.index) ||
                                i.insertBefore(
                                    this.selectpicker.view.titleOption,
                                    i.firstChild
                                ),
                            s && l.length && "back_forward" !== l[0].type
                                ? (i.selectedIndex = 0)
                                : "complete" !== document.readyState &&
                                  window.addEventListener(
                                      "pageshow",
                                      function () {
                                          e.selectpicker.view.displayedValue !==
                                              i.value && e.render();
                                      }
                                  );
                    }
                ...
                liHeight: function (e) {
                    if (
                        ...
                        if (
                            ...
                            for (
                                var m = 0;
                                m < this.selectpicker.current.data.length;
                                m++
                            ) {
                        ...
                        var b,
                            ...
                            z = {
                                ...
                                horiz:
                                    N(
                                        E ? E.paddingLeft : O.css("paddingLeft")
                                    ) +
                                    N(
                                        E
                                            ? E.paddingRight
                                    ...
                                    N(
                                        E
                                            ? E.borderLeftWidth
                                            : O.css("borderLeftWidth")
                                    ) +
                                    N(
                                        E
                                            ? E.borderRightWidth
                                            : O.css("borderRightWidth")
                                    ),
                            },
                            T = {
                                vert:
                                ...
                                horiz:
                                    ...
                                    N(
                                        E ? E.marginRight : O.css("marginRight")
                                    ) +
                                    2,
                            };
